...
\TLV
   ...
   // $next_pc[31:0] = $reset ? 32'b0 : ($pc + 32'b100);  // 4 bytes
   $pc[31:0] = >>1$next_pc;
   ...
   //
   // ==?, x: excluded from the comparison
   //---------------------------------------------------------------------------------
   ...
   $rf_result[31:0] = $is_load ? $ld_data :
                                 $result;
   ...
   *failed = *cyc_cnt > M4_MAX_CYC;
   ...
   m4+dmem(32, 32, $reset, $result[31:0], $is_s_instr, $src2_value[31:0], $is_load, $ld_data)
